<?php
    ...
    $pets = petViewForClient($link, $idUser);
?>
...
<body>
    ...
    <div class = "mainText">
    <h2><p>Вітаємо <?=$client['name']?></p></h2>
    <h4><p>Ваші особисті дані</p></h4>
    <div class="tablePet">
    <table>
        <tr>
            <th>ID</th>
    ...
    <a href = "clientEditForClient.php">Редагувати ваші персональні дані</a>
    <br>
    <h4><p>Дані ваших домашніх тварин</p></h4>
    <table>
        <tr>
            <th>ID</th>
            <th>Кличка</th>
        ...
        <?php foreach($pets as $pet): ?>
 		<tr>
            ...
            <td><a href = 'petEditForClient.php?id=<?=$pet['id']?>'>Редагувати</a>
        <br><a href = 'petEditForClient.php?action=delete&&id=<?=$pet['id']?>'>Видалити</a></td>	
 		</tr>
        <?php endforeach ?>
    </table>
    <br>
