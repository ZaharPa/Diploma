<?php
    ...
    $client = soloClientView($link, $idUser);

    if($_GET['action'] === 'edit'){
    updateClient($link, $idUser, $_POST['email'], $_POST['password'], $_POST['name'], $_POST['phone'], $_POST['address']);
...
<meta charset="utf-8">
    ...
    <title>Редагування запису про клієнта</title>
</head>
<body>
    ...
    <nav class = "navigation">
        <ul>
            ...
            <?php } else if ($loginUser == "doctor"){?>
                ...
                <li><a href = "../dateTable.php">Розклад</a></li>
                <li><a href = "../Doctor/newRecord.phpp">Запис на прийом</a></li>
                <li><a href ="../Reg/logout.php">Вийти</a></li>
    ...
    <h2>Редагувати даних про клієнта</h2>
    <form method="post" enctype="multipart/form-data" action = "clientEditForClient.php?action=edit">
        <br>
        <label>Пошта</label>
