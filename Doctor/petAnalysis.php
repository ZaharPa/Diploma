<?php
    ...
    if ($loginUser == 'admin'){
        ...
        $petAnalysis = petAnalysis($link);
        $labels = implode('","', array_keys($petAnalysis));
        $values = implode(',', $petAnalysis);
            ...
            datasets: [
                {
                    ...
                    label: 'Кількість прийомів тварин',
                    backgroundColor: [
                        '#fc1254',
                        '#fc8b12',
                        '#e5fc12',
        ...
        const config = {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Діаграма кількості прийомів тварин'
                    }
                }
            }
        };
