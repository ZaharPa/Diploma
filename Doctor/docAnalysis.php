<?php
    ...
    if ($loginUser == 'admin'){
        ...
        $docAnalysis = docAnalysis($link);
        $labels = implode('","', array_keys($docAnalysis));
        $values = implode(',', $docAnalysis);
        $bestDocName = implode(',', array_keys(bestDoc($link, max($docAnalysis))));
        $maxDoc = implode(',', bestDoc($link, max($docAnalysis)));
...
<body>
    ...
    <div class = "mainText">
        ...
        <br>
       <h4>Найкращий лікар нашої ветклінікі - <?=$bestDocName?> та має <?=$maxDoc?> відвідуваннь клієнтами</h4>
    </div>
            ...
            datasets: [
                {
                    ...
                    label: 'Кількість прийомів у лікаря',
                    backgroundColor: [
                        '#fc1254',
                        '#fc8b12',
                        '#e5fc12',
        ...
        const config = {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Діаграма кількості прийомів у лікарів'
                    }
                }
            }
        };
