<?php
    ...
    if ($loginUser == 'doctor' or $loginUser == 'admin'){
        ...
        $id = $_GET['id'];
        if($_GET['action'] === 'edit'){
            updatePet($link, $id, $_POST['alias'], $_POST['kind'], $_POST['breed'], $_POST['age'], $sex);
            $new_url = 'http://diploma/Doctor/petEdit.php';
...
<body>
    ...
    <form method="post" enctype="multipart/form-data" action = "petEditForm.php?id=<?=$_GET['id']?>&&action=edit">
        <br>
