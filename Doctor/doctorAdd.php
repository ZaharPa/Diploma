<?php
    ...
    if ($loginUser == 'admin'){
        ...
        $exp = $_POST['exp'];
        if ($login != ''){
            addDoctor($link, $login, $password, $name, $special, $cab, $exp);
...
<body>
    ...
    <h2>Додати лікаря</h2>
    <form method="post" enctype="multipart/form-data" action = "doctorAdd.php">
        <br>
        <label>Логін</label>
        ...
        <br>
        <label>Кабінет</label>
            <input type="text" name="cab" required>
        <br>
