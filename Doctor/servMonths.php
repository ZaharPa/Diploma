<?php
    ...
    if ($loginUser == 'admin'){
        ...
        $servByMonths = servByMonths($link);
        $labels = implode(',', array_keys($servByMonths));
        $values = implode(',', $servByMonths);
        foreach($servByMonths as $serv){
            $totalSum = $totalSum + $serv;
        }
?>
...
<meta charset="utf-8">
    ...
    <title>Аналіз прибутку по місяцям</title>
</head>
<body>
    ...
    <div class = "mainText">
        ...
        <br>
        <h4>Загальна кількість прибутку - <?=$totalSum?></h4>
    </div>
            ...
            datasets: [
                {
                    ...
                    label: 'Зароблені кошти за місяць',
                    backgroundColor: [
                        '#fc1254',
                        '#fc8b12',
                        '#e5fc12',
        ...
        const config = {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Діаграма зароблених коштів по місяцям'
                    }
                }
            }
        };
